...
- Q. 이 모델을 실제 BESS에 적용한다면 어떤 의사결정에 활용 가능한가?<br>
...
- Q. 어떤 한계가 있으며, 실 배포를 위해 추가로 필요한 것은 무엇인가?<br>
...
- 만약 성능이 전반적으로 아쉬웠다면 그에 대한 한계점<br>
